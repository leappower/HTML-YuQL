        ...
        ? [
          ...
          new CopyWebpackPlugin({
            patterns: [
              ...
              // Copy optimized images (WebP + compressed PNG) — generated by scripts/optimize-images.js
              // Falls back to original src/assets/images if optimize-images hasn't been run yet
              {
                from: 'src/assets/images-optimized',
                to: 'images',
                noErrorOnMissing: true,
                // Skip the manifest JSON file
                filter: (resourcePath) => !resourcePath.endsWith('optimized-manifest.json'),
              },
              {
